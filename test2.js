        function renderKidCharts() {
            ...
            initChart('chartBB', {
                ...
                data: {
                    labels: labels,
                    datasets: [
                        { label: 'IMT/U (BMIZ)', data: [], borderColor: '#8b5cf6', backgroundColor: 'rgba(139, 92, 246, 0.1)', borderWidth: 3, fill: true, tension: 0.4, pointBackgroundColor: '#8b5cf6', pointRadius: 4 },
                        { label: 'BB/U (WAZ)', data: [], borderColor: '#10B981', backgroundColor: 'transparent', borderWidth: 3, borderDash: [5, 5], tension: 0.4, pointBackgroundColor: '#10B981', pointRadius: 4 },
                        { label: 'BB/TB (WHZ)', data: [], borderColor: '#f59e0b', backgroundColor: 'transparent', borderWidth: 3, borderDash: [2, 2], tension: 0.4, pointBackgroundColor: '#f59e0b', pointRadius: 4 },
            ...
            initChart('chartTB', {
                ...
                data: {
                    labels: labels,
                    datasets: [
                        { label: 'TB/U (HAZ)', data: [], borderColor: '#4F46E5', backgroundColor: 'rgba(79, 70, 229, 0.1)', borderWidth: 3, fill: true, tension: 0.4, pointBackgroundColor: '#4F46E5', pointRadius: 4 },
                        { label: 'LK/U (HCFA)', data: [], borderColor: '#0ea5e9', backgroundColor: 'transparent', borderWidth: 3, borderDash: [5, 5], tension: 0.4, pointBackgroundColor: '#0ea5e9', pointRadius: 4 },
                        { label: 'Batas Bawah Normal (-2 SD)', data: Array(labels.length).fill(-2), borderColor: 'rgba(245, 158, 11, 0.6)', borderWidth: 2, borderDash: [10, 5], pointRadius: 0, fill: false },
            ...
            initChart('chartLila', {
                ...
                data: {
                    labels: labels,
                    datasets: [
                        { label: 'LiLA Terukur (cm)', data: [], borderColor: '#f43f5e', backgroundColor: 'rgba(244, 63, 94, 0.1)', borderWidth: 3, fill: true, tension: 0.4, pointBackgroundColor: '#f43f5e', pointRadius: 4 },
